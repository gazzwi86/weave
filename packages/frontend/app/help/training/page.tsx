...
import { filterTraining, groupByCategory } from "@/lib/onboarding/training-content";
    ...
    <main className="flex flex-col gap-[var(--space-6)] p-[var(--space-5)]">
      ...
      {filtered.length === 0 ? (
        ...
        grouped
          ...
          .map((group) => (
            <section key={group.category.categoryId} className="flex flex-col gap-[var(--space-3)]">
