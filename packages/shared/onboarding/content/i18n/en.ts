...
export const en: Record<string, string> = {
  ...
  "onboarding.exercise.ce-02.goal": "Add a product category ('Outdoor Furniture') via the chat panel.",
  "onboarding.exercise.ce-02.step1": "Open the chat panel.",
  "onboarding.exercise.ce-02.step2": "Ask it to add a category called 'Outdoor Furniture'.",
  "onboarding.exercise.ce-02.step3": "Confirm the commit to your sandbox.",
  "onboarding.exercise.ce-03.goal": "Find Process nodes with no owner (Actor) using raw SPARQL.",
  "onboarding.exercise.ce-03.step1": "Open Query and switch to SPARQL mode.",
  "onboarding.exercise.ce-03.step2": "Write a SELECT for Processes missing a performedBy actor.",
  "onboarding.exercise.ce-03.step3": "Run it and confirm rows return.",
  "onboarding.exercise.ce-03b.goal": "Find processes with no owner using plain English.",
  "onboarding.exercise.ce-03b.step1": "Open the chat panel.",
  "onboarding.exercise.ce-03b.step2": "Ask which processes have no assigned owner.",
  "onboarding.exercise.ce-03b.step3": "Read the results.",
  "onboarding.exercise.ge-01.goal": "Spotlight the 'Goods Inward' process neighbourhood in Explorer.",
  "onboarding.exercise.ge-01.step1": "Open Explorer.",
  "onboarding.exercise.ge-01.step2": "Find the 'Goods Inward' node.",
  "onboarding.exercise.ge-01.step3": "Turn on spotlight.",
  "onboarding.exercise.ge-02.goal": "Apply the maturity-score heatmap overlay.",
  "onboarding.exercise.ge-02.step1": "Open Explorer.",
  "onboarding.exercise.ge-02.step2": "Open the overlay menu.",
  "onboarding.exercise.ge-02.step3": "Turn on the maturity heatmap.",
  // Checklist.
  ...
  "onboarding.checklist.first-activation.label": "Reach your first milestone",
  "onboarding.checklist.first-activation.why": "This is the moment Weave starts working for you, not just showing you around.",
  "onboarding.checklist.invite-admin.label": "Invite your team",
  "onboarding.checklist.invite-admin.why": "Weave is more useful once your team's data is in the graph too.",
  "onboarding.checklist.connect-source.label": "Connect a data source",
  "onboarding.checklist.connect-source.why": "Pull data in automatically instead of entering it by hand.",
  "onboarding.checklist.locked.coming-soon": "Coming soon",
  "onboarding.checklist.badge.pending-platform-signal": "Pending",
  "onboarding.checklist.title": "Get started",
  "onboarding.checklist.title.celebrate": "You're all set!",
  "onboarding.checklist.celebrate.body": "You've completed every step -- welcome to Weave.",
