# Git Workflow — universal base

**Stack-agnostic.** Overrides the legacy `templates/standards/git-workflow.md`
which is TS-specific. Language-specific tooling (husky, pre-commit) is covered
in `templates/standards/<lang>/tooling.md` overlays.
...
## Stacked PRs by construction (Plugin Law D, Engineer Law 14)
...
**Essential.** Language-specific configuration lives in the relevant overlay
(`templates/standards/ts/tooling.md`, `python/tooling.md`, `java/tooling.md`).
...
*Universal base. Override per-stack in `templates/standards/<lang>/`.*
