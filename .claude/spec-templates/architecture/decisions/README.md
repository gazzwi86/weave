...
Each file in this directory records an architectural decision that shaped the system as it stands today. These are *historical* ADRs reverse-engineered from code + SME interviews, distinct from forward-looking ADRs in `docs/specs/<entity>/00-elicit/`.
