...
---
<!-- Current-state architecture. Mirrors the shape of docs/specs/<entity>/04-arch/tech-spec/architecture.md but documents WHAT IS, not what will be. -->
...
> See `.claude/state/discovery/coverage.yml` for per-language breakdown and `docs/specs/<entity>/04-arch/tech-spec/architecture.md` for the future-state design.
