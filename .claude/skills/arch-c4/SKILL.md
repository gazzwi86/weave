...
5. `docs/specs/<entity>/02-prd/prd.md` — the parent PRD; use it to identify actors,
   external systems, and integration requirements
6. `docs/specs/<entity>/03-roadmap/roadmap.md` — phase structure that shapes the diagram
   boundary (if present)
7. `docs/specs/<entity>/04-arch/` — any existing ADRs or prior architecture drafts
...
`docs/specs/<entity>/04-arch/tech-spec/architecture.md`
...
- Reference ADRs if they exist (link to `docs/specs/<entity>/04-arch/decisions/`)
...
```bash
git add docs/specs/<entity>/04-arch/tech-spec/architecture.md
...
**File:** `docs/specs/<entity>/04-arch/tech-spec/architecture.md`
