...
3. Any existing ADRs in `docs/specs/<entity>/04-arch/decisions/` to determine the next
   sequence number and avoid duplicating a decision already recorded
4. Any relevant tech-spec at `docs/specs/<entity>/04-arch/tech-spec/architecture.md` for context
...
1. Read existing ADRs in `docs/specs/<entity>/04-arch/decisions/` and determine `NNN`
...
```bash
git add docs/specs/<entity>/04-arch/decisions/ADR-NNN.md
...
> the relevant file in `docs/specs/<entity>/04-arch/tech-spec/` to reference this ADR."
...
File: `docs/specs/<entity>/04-arch/decisions/ADR-NNN.md`

Create the directory if it does not exist:

```bash
mkdir -p docs/specs/<entity>/04-arch/decisions
```
