...
4. The target task brief: `docs/specs/<entity>/04-arch/tasks/<TASK_ID>.md`
5. Any existing DoR for this task (`docs/specs/<entity>/04-arch/tech-spec/definition-of-ready.md`)
   to continue or refresh

Ask the user which entity and task ID this DoR is for if not supplied. Confirm the output path:

```
docs/specs/<entity>/04-arch/tech-spec/definition-of-ready.md
```
...
- [ ] Every ADR reference points to a file that exists:
  `docs/specs/<entity>/04-arch/decisions/ADR-NNN.md`
...
3. Commit:
   ```bash
   git add docs/specs/<entity>/04-arch/tech-spec/definition-of-ready.md
...
File: `docs/specs/<entity>/04-arch/tech-spec/definition-of-ready.md`
