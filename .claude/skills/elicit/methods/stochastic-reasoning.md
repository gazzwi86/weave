...
2. Write the analysis to the appropriate location:
   ...
   - If standalone: create `docs/specs/<entity>/00-elicit/STOCHASTIC-{topic-slug}.md`
...
- **Output captured to specs**: Decision record is saved to `docs/specs/<entity>/00-elicit/` or folded into an ADR
