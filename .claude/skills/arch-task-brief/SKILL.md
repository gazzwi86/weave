...
3. `.claude/specs/<entity>/02-prd/prd.md` — parent PRD; locate FRs that relate to this task
4. `.claude/specs/<entity>/02-prd/epics/EPIC-NNN.md` — parent epic; inherit priority, phase ref,
   and story list
5. `.claude/specs/<entity>/04-arch/tech-spec.md` — architecture decisions, API surface, data model
6. `.claude/specs/<entity>/04-arch/tasks/` — scan existing TASK-NNN.md files to determine the next
   sequence number (zero-pad to 3 digits: 001, 002, …) and to avoid `blocked_by` / `unlocks` gaps
7. Any existing ADRs in `.claude/specs/<entity>/04-arch/decisions/` that affect this task
...
`.claude/specs/<entity>/04-arch/tasks/TASK-NNN.md`
...
```bash
git add .claude/specs/<entity>/04-arch/tasks/TASK-NNN.md
...
```bash
git add .claude/specs/<entity>/02-prd/epics/EPIC-NNN.md
...
**File:** `.claude/specs/<entity>/04-arch/tasks/TASK-NNN.md`
...
```bash
mkdir -p .claude/specs/<entity>/04-arch/tasks/
```
