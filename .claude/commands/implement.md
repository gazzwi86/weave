...
4. Configure Vitest per docs/specs/<entity>/04-arch/tech-spec/testing-strategy.md
...
2. Display the phase gate checklist (from `docs/specs/<entity>/03-roadmap/roadmap.md` or the phase-gate template)
