...
10. **Create ADRs for undocumented design decisions.** If you make a decision not covered by existing ADRs, create one in `docs/specs/decisions/ADR-{NNN}.md`.
...
2. Read `docs/specs/tech-spec/testing-strategy.md` for test framework config
...
9. **Generate CI/CD pipeline** from `docs/specs/tech-spec/ci-cd.md`:
...
Read the task file from `docs/specs/tasks/TASK-{NNN}.md`. This contains everything you need:
