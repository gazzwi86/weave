...
10. When `docs/specs/<entity>/00-brownfield/` exists, read it and all shard files ONCE
...
12. Machine-checkable infrastructure artefacts. The `arch-infra` skill MUST emit an
    env-schema YAML at `docs/specs/<entity>/04-arch/tech-spec/env-schema.yaml`. The
    `arch-cicd` skill MUST emit executable workflow-stub YAMLs at
    `docs/specs/<entity>/04-arch/tech-spec/workflows/{ci,e2e,deploy}.yml`. Drift between
...
13. Spec invariants list. At the end of every tech-spec phase, write
    `docs/specs/<entity>/04-arch/tech-spec/invariants.md` — a flat checklist of
...
1. Check `docs/specs/<entity>/03-roadmap/roadmap.md` exists and `status: Approved`.
2. Read `brief.md`, `prd.md`, `roadmap.md`, and `epics/*.md` from `docs/specs/<entity>/`.
...
6. Announce the full plan to the user before proceeding:
   ...
   Output root: docs/specs/<entity>/04-arch/tech-spec/
...
Output: `docs/specs/<entity>/04-arch/tech-spec/stack.md`

After the skill completes and the section is approved, commit:
`git add docs/specs/<entity>/04-arch/tech-spec/stack.md && git commit -m "docs: add <entity> stack decisions"`

### Phase 3 — C4 architecture

Invoke the `arch-c4` skill.

Output: `docs/specs/<entity>/04-arch/tech-spec/architecture.md`
...
Output: `docs/specs/<entity>/04-arch/tech-spec/openapi.yaml`
...
Output: `docs/specs/<entity>/04-arch/tech-spec/data-model.md`
...
Output: `docs/specs/<entity>/04-arch/tech-spec/flows.md`
...
Output: `docs/specs/<entity>/04-arch/tech-spec/class-diagram.md`
...
- `docs/specs/<entity>/04-arch/tech-spec/workflows/ci.yml` (stub)
- `docs/specs/<entity>/04-arch/tech-spec/workflows/e2e.yml` (stub)
- `docs/specs/<entity>/04-arch/tech-spec/workflows/deploy.yml` (stub)
...
Output: `docs/specs/<entity>/04-arch/tech-spec/testing-strategy.md`
...
Output: `docs/specs/<entity>/04-arch/tech-spec/definition-of-done.md`
...
Output: `docs/specs/<entity>/04-arch/tech-spec/definition-of-ready.md`
...
- `docs/specs/<entity>/04-arch/tech-spec/env-schema.yaml`
...
Output: `docs/specs/<entity>/04-arch/decisions/ADR-{NNN}.md`
...
Output per task: `docs/specs/<entity>/04-arch/tasks/TASK-{NNN}.md`
...
1. Write `docs/specs/<entity>/04-arch/tech-spec/invariants.md` — flat checklist of
...
- Does not output specs to `docs/specs/` — all output goes to `docs/specs/<entity>/`.
