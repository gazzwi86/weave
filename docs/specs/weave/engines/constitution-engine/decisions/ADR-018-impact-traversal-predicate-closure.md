---
type: ADR
title: "ADR-018: Impact-traversal predicate closure (OQ-09)"
...
resource: docs/specs/weave/engines/constitution-engine/decisions/ADR-018-impact-traversal-predicate-closure.md
date: 2026-07-08
entity: constitution-engine
---

# ADR-018: Impact-traversal predicate closure (OQ-09)
...
with 18 predicates, each with domain, range, and inverse. m1 TASK-013 AC-6/AC-7 and the M2
...
is TASK-013's implementation concern; this ADR pins only the closure and its semantics.

## Consequences

- m1 TASK-013 AC-6/AC-7 unblock; M2 E4-S3 (pinned impact) and E2-S3-dependent tests can name
