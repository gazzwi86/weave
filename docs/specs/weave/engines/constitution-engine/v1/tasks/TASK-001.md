---
type: Task
title: "Task: TASK-001 — Ingest Foundation: Artefact Upload, Job Lifecycle, Proposal Store"
...
created: 2026-07-08
blocked_by: []
unlocks: [TASK-002, TASK-003, TASK-004, TASK-005, TASK-006, TASK-007, TASK-008]
...
The pipeline spine ONLY — no extractors (TASK-002+), no embeddings/retrieval (TASK-003), no
frontend page (TASK-008). IN: `POST /api/ingest/artefacts`, S3 corpus write (tenant-prefixed),
...
- **unlocks**: TASK-002..TASK-008 (every extractor and the page plug into this spine)
