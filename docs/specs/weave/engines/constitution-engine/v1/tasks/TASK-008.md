---
type: Task
title: "Task: TASK-008 — Import & Ingest Page, Epic E2E, CI Closure"
...
milestone: v1
created: 2026-07-08
blocked_by: [TASK-002, TASK-003, TASK-004, TASK-005, TASK-006, TASK-007]
unlocks: []
...
wiring of the structural asserts defined in TASK-001/003 plus the perf checks for ingest
...
/import page:
    ...
    <ProposalReview job>                            # one table, renderer per proposal kind:
        op-list card (TASK-002 component) | mapping row (+sourceType annotation) |
        merge side-by-side | flagged badge
        accept/reject -> TASK-001 endpoints; 422 -> inline violations
...
- **blocked_by**: TASK-002, TASK-003, TASK-004, TASK-005, TASK-006, TASK-007 (epic close —
  fronts and verifies all of them; TASK-001 is transitively required)
