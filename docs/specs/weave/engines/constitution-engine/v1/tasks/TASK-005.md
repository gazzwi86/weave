---
type: Task
title: "Task: TASK-005 — AI Diagram / Image-to-Data Ingest"
...
The vision extractor plugin (TASK-001 Protocol, kind=`image`) — a variant of TASK-002's
...
surface is TASK-002's (proposal cards render identically — source line shows the image
filename). OUT: OCR pipelines, diagram-notation auto-detection (a BPMN *file* is TASK-004; this
task is pixels).
...
No new endpoints — TASK-001 spine + TASK-002 chat cards. Mutation: **CE-WRITE-1** only.
...
| E12-S1 flow (shared) | [TASK-002](TASK-002.md) pseudocode + m1 TASK-006 diagrams | The review flow this reuses unchanged |
...
Minimum: 3 unit, 3 integration, E2E rides TASK-008.
...
- **blocked_by**: TASK-002 (tool schema, `to_ops`, chat cards, confidence gating all exist there
...
- [x] Shared flow + tool schema exist (TASK-002)
