...
tags: [weave-platform, 04-arch, tech-spec, m1, data-model]
status: Draft
timestamp: 2026-07-01T00:00:00Z
resource: docs/specs/weave/engines/weave-platform/04-arch/tech-spec/data-model.md
...
Seven supported connector types (M1 is configuration + health probe only;
connector ingestion activates post-M1):
`snowflake`, `databricks`, `s3`, `azure-datalake`, `atlassian`, `servicenow`, `slack`.
...
| `connector_ingest_jobs` | Platform / CE | Connector ingestion (E7-S3) needs CE-WRITE-1; post-M1 |
