...
description: "Implement the open-taxonomy notification system: in-app notification centre, Slack channel delivery via PLAT-CONNECTOR-1, per-user preferences, and graceful channel-failure handling."
