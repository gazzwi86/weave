---
type: Task
title: "Task: TASK-005 — PM Surface API Core: Projects Grid, Settings, Contributors (FR-006/007/008/009/060)"
...
created: 2026-07-08
blocked_by: [TASK-002]
unlocks: [TASK-006, TASK-007, TASK-010]
adr_refs: []
...
resource: docs/specs/weave/engines/build-engine/v1/tasks/TASK-005.md
---

# Task: TASK-005 — PM Surface API Core: Projects Grid, Settings, Contributors
...
> breach runtime is TASK-004), FR-009 (model-tier gating), FR-060 (contributors API).
...
| AC-5 | WHEN contributors are mutated, THE SYSTEM SHALL require the SETTINGS/CONTRIBUTORS guard (project admin or company/domain admin-owner) and persist via the TASK-001 repo | `should mutate contributors behind role guard` |
...
|---|---|---|
| Grid is one indexed query, no N+1 per card | AC-1 / p95 ≤ 300 ms | Budget summary comes from a denormalised read or single join — engineer must not call TASK-004 costs per card |
...
Deferred to TASK-006 (the Registry UI E2E exercises these routes end-to-end).
...
- **blocked_by:** [TASK-002] (Role Guard; TASK-001 transitively)
- **unlocks:** [TASK-006, TASK-007, TASK-010]
