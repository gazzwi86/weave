---
type: Task
title: "Task: TASK-008 — Kanban Board, Task Tree & Filters (FR-015/016/017)"
...
# Task: TASK-008 — Kanban Board, Task Tree & Filters (FR-015/016/017)
...
- **blocked_by:** [TASK-002] (guard family on the router; board reads are company-open but
  ride the same router registration)
- **unlocks:** [] (TASK-009's Task Detail opens from board cards — soft link, not blocking)
