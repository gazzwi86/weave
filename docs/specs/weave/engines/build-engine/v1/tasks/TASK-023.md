---
type: Task
title: "Task: TASK-023 — Source-Control Provider Config UI (E2-S6, FR-061/B9)"
...
resource: docs/specs/weave/engines/build-engine/v1/tasks/TASK-023.md
---

# Task: TASK-023 — Source-Control Provider Config UI (E2-S6, FR-061/B9)
...
| AC-6 | WHEN the config is mutated, THE SYSTEM SHALL require the SETTINGS guard class (project admin / company-or-domain admin-owner); denial = 403 + audit | Role Guard suite (TASK-011); route registration asserted here |
...
UI (settings tabs, TASK-015 family — new "Source control" tab):
...
- **blocked_by:** [TASK-015] (settings tabs this mounts in; TASK-011 guard transitively)
- **unlocks:** []
...
- The M1 repo-bootstrap step (m1 TASK-010) already reads this config — change nothing on the read
