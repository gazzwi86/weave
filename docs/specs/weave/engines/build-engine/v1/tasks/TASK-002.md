---
type: Task
title: "Task: TASK-002 — Role Guard (FR-060): Per-Project Roles Enforced at the API Boundary"
...
created: 2026-07-08
blocked_by: [TASK-001]
unlocks: [TASK-005, TASK-008, TASK-011]
adr_refs: []
...
resource: docs/specs/weave/engines/build-engine/v1/tasks/TASK-002.md
---

# Task: TASK-002 — Role Guard (FR-060): Per-Project Roles Enforced at the API Boundary
...
No new endpoint — a dependency consumed by every PM mutation route (TASK-005/007/012/013/014).
...
`project_contributors` via TASK-001 repo; `PLAT-AUDIT-1` emitter (M1
...
Deferred to the first UI task that mounts a guarded mutation (TASK-006 asserts the 403 path
...
- **blocked_by:** [TASK-001] (contributor repo methods)
- **unlocks:** [TASK-005, TASK-008, TASK-011] (TASK-012 consumes the guard transitively via
  TASK-010)
