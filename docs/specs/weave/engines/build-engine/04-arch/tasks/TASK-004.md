...
resource: docs/specs/weave/engines/build-engine/04-arch/tasks/TASK-004.md
---
...
- **Estimated cost:** ~$0.60 (claude-opus-4-8 pricing at time of writing; verify in MEMORY.md)
