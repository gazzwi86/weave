...
resource: docs/specs/weave/engines/build-engine/04-arch/tasks/TASK-007.md
---
...
- **Estimated cost:** ~$0.55 (claude-opus-4-8 pricing at time of writing; verify in MEMORY.md)
