...
milestone: M1
created: 2026-07-01
blocked_by: [TASK-001, TASK-002, TASK-004, TASK-005]
...
resource: docs/specs/weave/engines/build-engine/04-arch/tasks/TASK-006.md
---
...
> **Note on pseudocode depth:** The PDAC loop is implemented by a Sonnet + Opus advisor pair at
...
- **blocked_by:** [TASK-001, TASK-002, TASK-004, TASK-005]
- **unlocks:** [TASK-007, TASK-008]
- **External prerequisites:** `"PLAT-BILLING-1 metering endpoint available"`, `"Anthropic Agent SDK available in uv lockfile"`, `"Aurora state_spines and dep_summaries table migrations run"`

## Cost Estimate

- **Complexity:** XL
- **Estimated tokens:** ~20k input, ~10k output
- **Estimated cost:** ~$1.50 (claude-opus-4-8 pricing at time of writing; verify in MEMORY.md)
