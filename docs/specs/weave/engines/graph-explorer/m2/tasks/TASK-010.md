...
# Task: TASK-010 — GE-CANVAS-1 Packaging + Conformance Suite

## Story

**Epic:** [EPIC-009](../../../graph-explorer.md#epic-009--embeddable-canvas-component-ge-canvas-1--force-mode-m2-c4-mode-post-v1)
...
Consumes only existing surfaces: CE-READ-1 via read proxy (scoped load), TASK-004 write proxy
...
| Component delta | `../../tech-spec/m2-delta.md` | §6 | GraphCanvas export reuse edges (EditController, read proxy) |
...
- **blocked_by:** [TASK-004 (Edit Controller + write proxy — rule 5)]
- **unlocks:** TASK-011; **Build M2 decomposition** (external — the release gate this task exists for)
- **External:** TASK-009 closure config for the slice query (soft — a slice via direct
...
- [ ] Conventional commit(s); PR references this task and EPIC-009
