...
# Task: TASK-007 — Saved Views UI + Share + Comments + Poll Refresh

## Story

**Epic:** [EPIC-006](../../../graph-explorer.md#epic-006--async-share--comments--m2) +
[EPIC-007](../../../graph-explorer.md#epic-007--saved-views--layout--m2) (UI)
...
All server behaviour is TASK-006's; this task is panels + canvas wiring + poll loop.
...
function saveView(name, overwrite=false):
  body = { name, overwrite,
           ...
           positions: adapter.allNodePositions() }        # client sends drag-state (TASK-006 hint)
  resp = POST /api/views
...
|---------|------|---------|---------|
| Component delta | `../../tech-spec/m2-delta.md` | §6 | Views/Comments panels → Persistence Service; poll via read proxy |
| Sequence | `../../tech-spec/business-process.md` | graph-load flow | Loader reused by openView and poll merge |
...
- [x] API contracts defined (consumes TASK-006; no new routes; poll error rule)
...
- [ ] Conventional commit(s); PR references this task and EPIC-006/EPIC-007
