---
type: Decision
title: "ADR-008: M2 edit concurrency = GE-side since-version drift guard; server-side conditional
...
description: "FR-021 / E5-S3 originally demanded 'LWW-with-version-check, second writer gets 409'.
  ...
  it then. This ADR is the decision record behind the FR-021/E5-S3 rewording and the TASK-005
  drift-guard design."
tags: [decision, adr, graph-explorer, concurrency, fr-021, m2]
status: Accepted
timestamp: 2026-07-08T00:00:00Z
resource: docs/specs/weave/engines/graph-explorer/decisions/ADR-008-m2-concurrency-client-drift-guard.md
...
# ADR-008: M2 edit concurrency = client-side drift guard, not a CE 409
...
1. **M2 lost-update protection is GE-side.** On edit start, GE captures the draft head
   ...
   against the fresh base (TASK-005 AC-2).
...
- The M2 release gate (TASK-011 via `invariants.md`) verifies
