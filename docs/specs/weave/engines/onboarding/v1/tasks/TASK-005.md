...
description: "The v1-interim release evidence for the Onboarding M2 window: axe-with-overlay-open
  ...
  CE-METRICS-1 starter-tile un-omit assertion (Platform E1-S6 / v1 TASK-010 behaviour)."
...
| Tile-flip asserted here, not built anywhere | m2-delta §2 verify-not-build decision made testable; behaviour is Platform E1-S6 (Platform v1 TASK-010), not TASK-017 | m2-delta §2/§9; red-team fix 6 |
