...
[m2-delta.md](../../tech-spec/m2-delta.md) §2, §4–§5 · Owning surface: Platform v1 TASK-017
...
- **unlocks**: TASK-005
- **External (DoR, not DAG):** Platform v1 TASK-017 merged (role-home exists to plant on).
  Until this task plants and flips the five anchors they stay `shipped: false`, so nothing
  renders (ADR-008) — config-first merge stays safe. **No CE dependency** (CE v1 TASK-010 is
