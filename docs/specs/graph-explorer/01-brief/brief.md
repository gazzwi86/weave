...
description: "Brief for the Weave Graph Explorer — the visual, real-time collaborative canvas onto the company graph."
tags: [graph-explorer, 01-brief, visualization, collaboration]
